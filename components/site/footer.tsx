...
const socials = [
  {
    label: 'Twitter',
    href: 'https://twitter.com/gionaka',
  ...
  {
    label: 'Instagram',
    href: 'https://instagram.com/gionaka',
  ...
  {
    label: 'Facebook',
    href: 'https://facebook.com/gionaka',
    path: 'M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073Z',
  },
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/company/gionaka',
    ...
    <footer id="contact" className="border-t border-border bg-muted/30">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <div className="grid gap-10 md:grid-cols-[1.5fr_1fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-xs leading-relaxed text-muted-foreground">
              India’s Digital Labour Chowk. Find work, hire local, build India —
              all from one app.
            </p>
            <a
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-6 text-sm text-muted-foreground sm:flex-row">
          <p>© {new Date().getFullYear()} Gionaka. All rights reserved.</p>
